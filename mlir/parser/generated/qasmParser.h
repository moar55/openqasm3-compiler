...
public:
  enum {
    ...
    MUL = 105, DIV = 106, MOD = 107, IMAG = 108, ImagNumber = 109, COMPLEX = 110, 
    HASH = 111, CONST = 112, MUTABLE = 113, ARRAY = 114, SIZEOF = 115, DIM = 116, 
    Constant = 117, Whitespace = 118, Newline = 119, Integer = 120, Identifier = 121, 
    RealNumber = 122, TimingLiteral = 123, StringLiteral = 124, LineComment = 125, 
    BlockComment = 126
  };
