...
//      }
//      auto proto2 = mlir::func::FuncOp::create(
//              builder.getUnknownLoc(), "__internal_mlir_" + func_name, func_type2);
//      mlir::func::FuncOp function2(proto2);
...
//      auto symbol_table = my_visitor->getScopedSymbolTable();
...
//
//          auto proto =
//                  mlir::func::FuncOp::create(builder.getUnknownLoc(), "main", func_type);
...
//
//          auto x=  builder.create<mlir::IntegerOp>(//loc, 5)
//                  sybmol_talbe.insert(x)
//          // call the function from main, run finalize, and return 0
//          auto call_internal =
//                  builder.create<mlir::func::CallOp>(builder.getUnknownLoc(), function2);
...
////          auto proto3 =
////                  mlir::func::FuncOp::create(builder.getUnknownLoc(), file_name, func_type3);
////          mlir::func::FuncOp function3(proto3);
////
...
//
//    void MLIRGenerator::finalize_mlirgen() {
//
//      auto scoped_symbol_table = my_visitor->getScopedSymbolTable();
...
//        auto temp = builder.create<mlir::quantum::DeallocOp>(builder.getUnknownLoc(), op);
//      }
//
...
//        auto ret = builder.create<mlir::func::ConstantOp>(builder.getUnknownLoc(), integer_attr);
//        auto temp = builder.create<mlir::func::ReturnOp>(builder.getUnknownLoc(),
